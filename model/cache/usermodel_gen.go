...
func newUserModelForConn(conn sqlc.CachedConn) *defaultUserModel {
	return &defaultUserModel{
		CachedConn: conn,
		table:      "`user`",
	}
...
func (m *defaultUserModel) Insert(ctx context.Context, data *User) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Name, data.Password, data.Mobile, data.Gender, data.Nickname, data.Type, data.CreateAt, data.UpdateAt)
...
func (m *defaultUserModel) Update(ctx context.Context, newData *User) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.Name, newData.Password, newData.Mobile, newData.Gender, newData.Nickname, newData.Type, newData.CreateAt, newData.UpdateAt, newData.Id)
	}, userIdKey, userMobileKey, userNameKey)
	return err
}

...
func (m *defaultSchoolModel) Insert(ctx context.Context, data *School) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.Name, data.UserId, data.Type, data.CreateAt, data.UpdateAt)
	return ret, err
}
...
func (m *defaultSchoolModel) Update(ctx context.Context, data *School) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.Name, data.UserId, data.Type, data.CreateAt, data.UpdateAt, data.Id)
	return err
}
